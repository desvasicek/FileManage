...
class File:
    def __init__(self, row, column, filepath, filename):
        if os.path.isfile(filepath):
            self.image = PhotoImage(file="/home/pi/File Manager/icons/blank.png")
        else:
            self.image = PhotoImage(file="/home/pi/File Manager/icons/Folder-0.png")
            if filename == "Downloads":
                self.image = PhotoImage(file="/home/pi/File Manager/icons/Folder Downloads-0.png")
        if filename.endswith(".zip"):
            self.image = PhotoImage(file="/home/pi/File Manager/icons/Zip-0.png")
        elif filename.endswith(".exe"):
            self.image = PhotoImage(file="/home/pi/File Manager/icons/exe-0.png")
        elif filename.endswith(".mp3") | filename.endswith(".wav") | filename.endswith(".ogg"):
            self.image = PhotoImage(file="/home/pi/File Manager/icons/Audio-0.png")
        elif filename.endswith(".mp4") | filename.endswith(".vid"):
            self.image = PhotoImage(file="/home/pi/File Manager/icons/Video file-0.png")
        elif filename.endswith(".png") | filename.endswith(".jpg") | filename.endswith(".jpeg") | filename.endswith(".ico"):
            self.image = PhotoImage(file="/home/pi/File Manager/icons/Photos file-0.png")
...
app.config(bg="white")
app.call("source", "/home/pi/File Manager/arc/arc.tcl")
app.iconphoto(False, PhotoImage(file="/home/pi/File Manager/icons/Folder-0.png"))
